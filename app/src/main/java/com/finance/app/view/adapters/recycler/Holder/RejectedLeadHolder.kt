...
class RejectedLeadHolder(val binding: ItemRejectedLeadBinding, val mContext:Context) : RecyclerView.ViewHolder(binding.root) {
    fun bindItems(lead: AllLeadMaster) {
        ...
        binding.tvLeadStatus.setDrawableColor(R.color.md_red_200)
